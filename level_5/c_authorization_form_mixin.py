...
if __name__ == '__main__':
    stas = AuthorizationForm(username='Stas', password='qwer12345')
    print(stas.valid_form())

    alice = AuthorizationForm(username='Alice_2023', password='qwer12345')
    print(alice.valid_form())
